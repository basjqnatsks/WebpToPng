...
class NewFileHandler(FileSystemEventHandler):
    ...
    async def convert_to_png(self, filepath):
        try:
            ...
            # Trigger the Windows clickable notification
    ...
    def show_clickable_notification(self, png_filename):
        ...
        # Show Windows notification using win10toast-click with a click action
        self.notifier.show_toast(
            "Png Conversion Successful",
            f"Click to open: {os.path.basename(png_filename)}",
            duration=10,  # The notification will stay for 10 seconds
            threaded=True,
            callback_on_click=open_file  # This function will run when the notification is clicked
        )
...
if __name__ == "__main__":
    directory_to_watch = "G:\\Downloads"  # Change to the directory you want to monitor
